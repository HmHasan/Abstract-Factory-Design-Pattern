    ...
    <table>
        <table border="3">
            ...
            <tr>
                ...
                <td><?php echo "<a href='show_teacher.php?action=edit&id=$value[id]'>Edit</a>"?> || 
                <?php echo "<a href='show_teacher.php?action=delete&id=".$value['id']."'onClick='return confirm(\"Are You Sure\")'>Delete</a>"?>
                </td>
            </tr>
            <?php  } ?>
        </table>
